...
class nbuappliance::params {
  ...
  $callhome_email               = undef
  $callhome_email_hwadmin       = undef
  $callhome_email_swadmin       = undef
  $callhome_email_senderid      = undef
  $callhome_smtp_server         = undef
  $callhome_notification_interval = '300'
  $callhome_snmp_community      = 'PUBLIC'
  $callhome_snmp_port           = '162'
  $callhome_snmp_enable         = undef
  $proxy_enable                 = undef
  $proxy_server                 = undef
  $proxy_port                   = undef
  $proxy_user                   = undef
  $proxy_pass                   = undef
  $callhome_contact             = undef
  $callhome_contactemail        = undef
  $callhome_address             = undef
  $callhome_city                = undef
  $callhome_zip                 = undef
  $callhome_state               = undef
  $callhome_country             = undef
  $callhome_companyname         = undef
  $callhome_phone               = undef
